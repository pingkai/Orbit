        ...
        <View style={styles.centeredContent}>
          ...
          <Animated.View entering={FadeInDown.delay(500)} style={styles.featureContainer}>
            <View style={styles.iconWrapper}>
              <Ionicons name="infinite" size={26} color="#32CD32" />
            </View>
          ...
          <Animated.View entering={FadeInDown.delay(700)} style={styles.featureContainer}>
            <View style={styles.iconWrapper}>
              <Ionicons name="person" size={26} color="#32CD32" />
            </View>
            <View style={styles.textWrapper}>
...
{/* 
          ...
          <Animated.View entering={FadeInDown.delay(900)} style={styles.featureContainer}>
            <View style={styles.iconWrapper}>
              <Ionicons name="shield-checkmark" size={26} color="#32CD32" />
            </View>
            <View style={styles.textWrapper}>
          ...
          <Animated.View entering={FadeInDown.delay(1100)} style={styles.featureContainer}>
            <View style={styles.iconWrapper}>
              <Ionicons name="headset" size={26} color="#32CD32" />
            </View>
            <View style={styles.textWrapper}>
...
const styles = StyleSheet.create({
  ...
  iconContainer: {
    flexDirection: "row",
    gap: 12,
    marginBottom: 10, // reduced spacing between icons and heading
  },
  icon: {
    opacity: 0.9,
  },
  heading: {
    ...
    fontWeight: "bold",
    textAlign: "center",
    marginBottom: 20, // reduced spacing below heading
    letterSpacing: 1,
  },
  featureContainer: {
    flexDirection: "row",
